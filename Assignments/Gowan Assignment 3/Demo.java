/*Assignment 3, Demo, CSCI 1101
Demo.java creates three ArrayList's, one for each player and a separate one for when wars occurs.
It contains a main outer loop, and a main inner loop. The main outer loop only runs if the user
wishes to play again. The inner loop creates the Array Lists, a deck object (which it shuffles), 
and adds 26 cards from the Deck class to each of the player Array Lists. After getting the names
of the users, it then evaluates who the winner of the game would be, and shows all the steps as 
to who wins.
July 16th, 2015
...
public class Demo{
   public static void main(String[] args){
      ...
      String gameWinner = "";
      while(playAgainOption){//main outer loop
