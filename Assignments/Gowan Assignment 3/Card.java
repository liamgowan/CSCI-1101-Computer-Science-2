/*Assignment 3, Card, CSCI 1101
Card.java can contain information about a particular card. It's attributes contain data concerning 
it's suit, it's rank and it's value. It has a constructor which sets the suit, rank, and value 
(depending on what the rank is). It has methods to access and mutate these variables. It has a 
method to see if this card object is greater than another one. It has a toString method, which
returns the suit and rank of the card. It also has a method which can copy the card.
July 16th, 2015
